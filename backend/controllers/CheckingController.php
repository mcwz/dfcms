...
class CheckingController extends Controller
{
     ...
     */
    public function actionCheck($cid, $type = 'sendToCheck', $categoryid = 1)
    {
        if(is_numeric($cid))
        {
            ...
            if($content)
            {
                ...
                //以下仅仅为了显示
                if ($content->status == Content::STATUS_EDITING && $type == 'beforeSendCheck') {
                    ...
                    } else {//可能是没有审核流程，那么就直接通过吧 To Do
                        return $this->redirect('/content/index?categoryid=' . $categoryid);
                    }
                }
            }
            return $this->redirect('/content/index?categoryid=' . $categoryid);
