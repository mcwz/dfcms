...
--
-- Host: localhost
-- Generation Time: 2016-03-13 09:16:43
-- 服务器版本： 5.7.11
-- PHP Version: 5.6.19
...
(1, '新', 'ccccc7ddd', 1, 'admin', 1, 1457771188, 1457790258, 3);
...
INSERT INTO `nodes` (`id`, `pid`, `name`, `description`, `pos`, `type`, `attr_group_id`, `flow_group_id`, `path`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, '根节点', '初始根节点', 1, 1, 0, 0, 'root', 1, 1456314502, 1456541383),
